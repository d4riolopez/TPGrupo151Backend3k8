...
public class AuthController {
    ...
    public AuthController(ReactiveAuthenticationManager authenticationManager, ReactiveUserDetailsService userDetailsService) {
                ...
                .flatMap(authentication -> {
                    return Mono.subscriberContext()
                            .flatMap(context -> {
                                ...
                                return Mono.just(generateToken(authRequest.getUsername()));
                            });
                })
